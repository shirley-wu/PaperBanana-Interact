...
parser = argparse.ArgumentParser(description="Generate a category style guide from a benchmark dataset")
parser.add_argument(
    "--dataset_name",
...
DATA_DIR = WORK_DIR / "data" / args.dataset_name

INPUT_JSON_PATH = DATA_DIR / "ref.json"
