...
class RetrieverAgent(BaseAgent):
    ...
    async def process(self, data: Dict[str, Any], retrieval_setting: str = "auto") -> Dict[str, Any]:
        ...
        ref_file = self.exp_config.dataset_dir / "ref.json"
        ...
        if retrieval_setting == "manual":
            manual_file = self.exp_config.dataset_dir / "agent_selected_12.json"
    ...
    def _load_manual_references(self, cfg: dict) -> tuple:
        ...
        if cfg["task_name"] == "diagram":
            few_shot_file = self.exp_config.dataset_dir / "agent_selected_12.json"
    ...
    def _load_random_references(self, cfg: dict) -> list:
        ...
        with open(self.exp_config.dataset_dir / "ref.json", "r", encoding="utf-8") as f:
