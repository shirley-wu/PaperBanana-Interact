...
class PolishAgent(BaseAgent):
    ...
    async def _generate_suggestions(self, gt_image_b64: str, style_guide: str) -> str:
        ...
        content_list = [
            ...
            {"type": "image", "source": {"type": "base64", "media_type": "image/jpeg", "data": gt_image_b64}},
        ]
    ...
    async def process(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        gt_image_path = self.exp_config.dataset_dir / gt_image_path_rel
        ...
        try:
            if generation_utils.provider_key("openrouter"):
                image_config = {
